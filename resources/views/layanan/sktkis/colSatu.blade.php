<div class="col bg-white mr-1 colSatu">
    ...
    <input type="text" id="id" name="penduduk_id" class="mb-3" hidden>
    @csrf
    <div class="input-group">
            <div class="input-group-prepend">
                <button class="btn btn-secondary t_cari" type="button"  data-toggle="modal" data-target="#modal">Cari</button>
            </div>
        ...
        <div class="form-group">
            ...
            <input readonly autocomplete="off" type="text" class="form-control @error('jeniKelamin') is-nvalid @enderror" id="jenisKelamin" name="jenisKelamin" value="{{ old('jeniKelamin') }}">
            @error('jeniKelamin')
                    <div class="invalid-feedback">
                            {{ $message }}
                    </div>
