<div class="row">
    <div class="col">
        <button type="button" class="btn btn-primary btn-block" id="t_tambahPenduduk"  data-toggle="modal" data-target="#modalTambahPenduduk">Tambah Data Penduduk</button>
    </div>
    <div class="col">
        <form action="/penduduk">
            <div class="input-group mb-3">
                ...
                <input type="text" class="form-control" placeholder="penduduk...." aria-describedby="button-addon1" name="search" autocomplete="off" value="{{ request('search') }}">
            </div>
        </form>
    </div>
</div>
...
{{-- modalTambahPenduduk --}}
    <div class="modal fade" id="modalTambahPenduduk" tabindex="-1" aria-labelledby="modalTambahPendudukLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="modalTambahPendudukLabel">Tambah Penduduk</h5>
        ...
        <div class="modal-body" style="background-color: rgb(236, 236, 236)">
            ...
            <input autocomplete="off" class="form-control @error('kewarganegaraan')is-invalid @enderror" type="text" placeholder="Kewarganegaraan" id="kewarganegaraan" name="kewarganegaraan" value="Indonesia" readonly>
